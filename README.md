...
Полнофункциональная CRM-система для управления проектами, контекстами, складами и пользователями с системой ролей и разрешений.
...
Приватный проект ВММебель CRM. Все права защищены.
